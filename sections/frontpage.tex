...
\vspace*{\fill}
  ...
  {\color{white}\fboxsep0pt\colorbox{aaublue}{\begin{tabular}{@{}p{\textwidth}@{}}
    \begin{center}
    \Huge{\textbf{
      Arbejdsblade til statusseminar% insert your title here
    }}
    \end{center}
    \begin{center}
      \large{
        Parameterestimation med klassisk statistik og bootstrapping% insert your subtitle here
      }
    \end{center}
   
   \begin{center}
    \Large{
      Gvidas Rimkus, Mathilde S. Andersen, Mikkel K. Rørbæk, \\ Nikolai Kaaberbøl, Rasmus B. V. Pedersen,\\ Søren L. Pedersen, Thor M. Sørensen}% insert names separated by comma
    \\
    
    \vspace{0.5cm}
    {\large
      Datavidenskab og machine learning, cs-23-dvml-2-01% insert name of study, group number, year-month
    }
   \end{center}
   \vspace{0.2cm}
